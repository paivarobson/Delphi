...
begin
  ...
  FController.DadosFieldData.OnSetText := FormatacaoEValidacaoCampoData; //Atribui validação da data direto no CDS
...
//Métódo verifica as ocasições que os BOTÕES ALTERAR e EXCLUIR devem serem habilitados ou não
