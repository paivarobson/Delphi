...
uses
  ...
  ExtCtrls, DBCtrls, unDados, unCadastroEscolaController, ADODB, ComCtrls;
...
begin
  ...
  if edtEscolaBuscarCodigo.Text <> '' then
    ADOTableEscola.Locate('ESCCOD', edtEscolaBuscarCodigo.Text, [LopartialKey])
  else
    ADOTableEscola.Locate('ESCDATACAD', FormatDateTime('DD/MM/YYYY', dtpEscolaBuscarData.Date), [LopartialKey])
end;
