...
type
  ...
  public
    procedure CarregarEscola(AEscolaModelo: TEscolaModelo; ACodigo: Integer);
  end;
...
procedure TEscolaDAO.CarregarEscola(AEscolaModelo: TEscolaModelo; ACodigo: Integer);
var
  VQuery: TSQLQuery;
begin
  VQuery := fmdados.ComponenteQuery;
  try
    VQuery.CommandText := 'SELECT ' +
                 'ESCCOD, ' +
                 'ESCNOME, ' +
                 'ESCDATACAD, ' +
                 'ESCENDCEP, ' +
